...
s=s.replace("console.log('🗽 NEW YORK — DUKASCOPY QUICK OPTIMIZER');","console.log('⚡ NEW YORK — STEP 4: MOMENTUM ONLY');");
...
const newCfg="const configs=[1,2,3].map(momentumMin=>({adxMin:24,chaseMax:0.20,rr:1.0,bodyMax:0.20,momentumMin}));";
