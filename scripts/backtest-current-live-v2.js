#!/usr/bin/env node
'use strict';
/** CURRENT LIVE V2 parity runner — CommonJS-safe. */
...
// Compile as a normal CommonJS module so require/__dirname work on Node 26/Termux.
const generated=path.join(__dirname,'backtest-current-live-v2.generated.js');
