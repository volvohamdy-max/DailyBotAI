...
const CLOSE=M.map(x=>x.c),R=rsi(CLOSE,C.rsiPeriod),E20=ema(CLOSE,20);
...
console.log('\n🧪 PRO 1106 + EMA20 FILTER — 1 YEAR');
console.log('DATA:',file,'| M5:',M.length);
console.log('TEST: BASE + EMA20 direction filter | BUY close>EMA20 | SELL close<EMA20');
