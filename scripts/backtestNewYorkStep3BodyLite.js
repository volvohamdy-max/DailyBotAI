...
s=s.replace("console.log('🗽 NEW YORK — DUKASCOPY QUICK OPTIMIZER');","console.log('⚡ NEW YORK — STEP 3: BODY ONLY (ADX 24 / CHASE 0.20)');");
...
const neu="const configs=[0.35,0.25,0.20].map(bodyMax=>({adxMin:24,chaseMax:0.20,rr:1.0,bodyMax}));";
