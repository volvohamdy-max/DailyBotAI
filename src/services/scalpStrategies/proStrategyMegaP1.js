...
async function scan(){
 ...
 if(side==='BUY'&&(ADX[i]<20||atrRatio<0.40||atrRatio>1.30||bodyRatio<0.55||momentum3h===null||momentum3h< -25))return wait('PRO_BUY_FILTER_BLOCK',{adx5:ADX[i],atrRatio,bodyRatio,momentum3h});
